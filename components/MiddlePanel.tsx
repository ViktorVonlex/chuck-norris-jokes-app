    ...
    <>
      <div className="mx-auto text-white w-1/2">
          ...
          <div className="flex text-center mt-5">
              <div className="w-2/3 mr-1 middle-button p-4 flex items-center justify-center text-xl" onClick={() => getRandomJoke()}>Get random joke!
                <Image className="ml-3" alt="Chuck icon" width="50" height="50" src="https://img.icons8.com/plasticine/50/null/chuck-norris.png"/>
              </div>
              <div className="w-1/3 ml-1 middle-button p-4 flex items-center justify-center text-xl" onClick={() => {
                setLoading(true)
                saveJoke(jokeUrl)
              }}>Save this joke</div>
          </div>
