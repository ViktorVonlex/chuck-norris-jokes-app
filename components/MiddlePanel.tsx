  ...
  return (
    <div className="mx-auto text-white w-1/2">
        ...
        <div className="w-full bg-gray-900 mt-5 pt-4 rounded-3xl">
            ...
            <div className="text-center bg-gray-800 w-full text-green-600 text-2xl rounded-b-3xl p-4 pb-10 pt-10">Chuck Norris's football team won the NBA champinship against the tennis player Roger Federer</div>
        </div>
    </div>
  )
}